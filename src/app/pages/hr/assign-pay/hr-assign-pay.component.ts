...
export class HrAssignPayComponent implements OnInit {
  ...
  selectedEmpId    = '';
  selectedEmpTypeId = '';
  selectedStructId = '4cbf4b44-d15b-4b6c-83f8-e59194cdf29f';
  ...
  assign() {
    ...
    this.loading = true;
    this.msg = '';
    this.assignService.assign({ empId: this.selectedEmpId, payStructureId: '4cbf4b44-d15b-4b6c-83f8-e59194cdf29f' }).subscribe({
      next: res => {
