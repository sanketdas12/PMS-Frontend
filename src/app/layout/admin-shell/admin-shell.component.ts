...
export class AdminShellComponent implements OnInit, OnDestroy {  // ✅ added OnDestroy
  ...
  private getCurrentFinancialYear(): string {
    ...
    const year = today.getMonth() >= 3  // April (month 3) starts new FY
      ? today.getFullYear()
      : today.getFullYear() - 1;
  ...
  ngOnInit(): void {
    this.warmupTimer = setTimeout(() => {
      ...
      this.taxSlabService.getAll(this.getCurrentFinancialYear()).subscribe({ error: () => {} }); // ✅
    }, 900);
  }
