...
export class AdminSidebarComponent {
  ...
  sections: SidebarSection[] = [
    ...
    },
    {
      title: 'Payroll',
      items: [
        { label: 'Process Payroll',    path: '/admin/process-payroll', icon: 'process', badge: 'Live', badgeClass: 'badge-green' },
        { label: 'Assign Pay Structure', path: '/admin/assign-pay', icon: 'assign' },
